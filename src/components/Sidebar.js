...
export default function Sidebar({ user }) {
  ...
  return (
    <>
      ...
      <div
        className={`${
          open ? "left-[208px]" : "left-0"
        } max-mobile:flex absolute hidden py-[20px] pl-1 pr-3 h-fit justify-between items-center rounded-r-full transtion bg-white top-2/4 shadow`}
      >
